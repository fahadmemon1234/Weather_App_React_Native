...
import { SafeAreaView ,View, Text, TextInput, TouchableOpacity, FlatList, ImageBackground, Image } from 'react-native';
  ...
  return(
    ...
    <SafeAreaView>
      <View>
        ...
        style={{ height: deviceHeight, width: deviceWidth}} imageStyle={{opacity: 0.6,
